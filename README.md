...
Type:
    ...
    bash run_dTOX.bsh species seq_type plus_strand_bw minus_strand_bw out_prefix filter gpu_cores cpu_cores

    Species         -- Currently only hg19 and mm10 by default, for other species, please refert to 3).
...
Type:
    ...
    bash extract_TF.bsh species TF_name dTOX_reult out_file
    Species         -- Currently only hg19 and mm10
